...
public abstract class Animal extends Mob implements IConversionJSON, IFila {
    ...
    public void setTipoAlimentacion(String tipoAlimentacion) throws Atributo_vacio_Exception, Valor_de_atributo_no_valido_Exception{
        if (tipoAlimentacion == null) throw new Atributo_vacio_Exception("El tipo de alimentación no puede estar vacío.");
        ...
        else throw new Valor_de_atributo_no_valido_Exception("El tipo de alimentación no es válido.");
    }
